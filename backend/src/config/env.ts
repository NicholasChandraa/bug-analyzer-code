...
const envSchema = z.object({
  ...
  // Engine (Python/FastAPI) - base URL buat invoke agent. Backend→Engine satu-satunya call.
  ENGINE_URL: z.string().url("ENGINE_URL harus berupa URL yang valid").default("http://localhost:8000"),
})
